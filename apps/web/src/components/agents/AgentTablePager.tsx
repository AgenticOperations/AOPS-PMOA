...
export function AgentTablePager({ itemLabel, onPageChange, page, pageSize, total }: AgentTablePagerProps) {
  ...
  return (
    <nav aria-label={`${itemLabel} pagination`} className="agent-table-pager">
      <span>Showing {start}-{end} of {total}</span>
      <div className="agent-table-page-controls">
        <button
